---
name: xxd-panel-212
description: "Create Panel 212 raster artwork: Near-monochrome Sculptural Form Study. Use when the user invokes xxd-panel-212 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-212/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-212-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
